...
default_pretrained_model_path = os.path.join(here, '../pretrained_models/bert-guwen')
default_train_file = os.path.join(here, '../datasets/train_all.jsonl')
default_validation_file = os.path.join(here, '../datasets/val_all.jsonl')
default_test_file = os.path.join(here, '../datasets/val_all.jsonl')
default_result_file = os.path.join(here, '../datasets/result_all.jsonl')
default_output_dir = os.path.join(here, '../saved_model')
...
parser.add_argument("--result_file", type=str, default=default_result_file)
